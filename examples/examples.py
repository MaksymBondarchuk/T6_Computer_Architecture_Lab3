...
def example11():
    ...
    Indexes present:
      ...
      :title node-element-equality-date
      :title edge-element-equality-string
    """
...
def example13():
    ...
    try:
        ...
        container.putDocument("foo0",
                              r"<?xml version='1.0' ?><!DOCTYPE root SYSTEM 'mydtd.dtd'><root><a>yyz</a></root>", uc);
